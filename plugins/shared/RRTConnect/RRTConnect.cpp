...
{
    if (stateSamplingFunction_)
        return stateSamplingFunction_();
...
IsValidFunction RRTConnect::getIsValidFunction() const {
    return isValidFn_;
}

bool RRTConnect::isValid(const RobotStateSharedPtr& state) {
...
InterpolationFunction RRTConnect::getInterpolationFunction() const {
    return interpolationFunction_;
}

void RRTConnect::setStateSamplingFunction(StateSamplingFunction stateSamplingFunction) {
    stateSamplingFunction_ = stateSamplingFunction;
}
