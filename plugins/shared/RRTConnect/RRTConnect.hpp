...
typedef std::function<RobotStateSharedPtr()> StateSamplingFunction;
...
public:
    ...
    IsValidFunction getIsValidFunction() const;
    ...
    void setStateSamplingFunction(StateSamplingFunction stateSamplingFunction);

    bool isValid(const RobotStateSharedPtr& state);
...
private:
    ...
    StateSamplingFunction stateSamplingFunction_ = nullptr;    
